...
<div class="mx-auto max-w-6xl px-4 py-14 sm:px-6">
	<header class="max-w-3xl">
		<p class="text-coral-600 text-sm font-semibold tracking-[0.2em] uppercase">Les données</p>
		<h1 class="font-display mt-3 text-4xl font-semibold sm:text-5xl">
			Tout est publié. Croisez ce que vous voulez.
		</h1>
	...
	{#if data.surveys.length === 0}
		<p class="brut bg-surface rounded-card mt-12 p-8 text-center">
			Aucune enquête n'est encore publiée. Le tour est en cours.
		</p>
	{:else}
